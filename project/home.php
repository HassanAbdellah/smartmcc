...
if (isset($_FILES['file']['name'])) {
    ...
    if(isset($_REQUEST['register'])) {
        ...
        if ($num > 0) {
            ...
            $result = mysqli_query($con, "insert into userinfo (fName,lname,gender,email,mobile,password,address,bdate,file_name, file_ext, reg_date, upd_date)
                  values ('$fName','$lName', '$gender', '$email', '$mobile', '$password', '$address', '$bdate', '$file_name', '$file_ext', '$reg_date','$upd_date')");
...
?>
                    ...
                    <div class="tab-pane" id="Registration">
                        <form role="form" method="post" class="form-horizontal" enctype="multipart/form-data"><br>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <input type="date" class="form-control" id="bdate" name="bdate" placeholder="Enter your birth date..."
                                              rows="3" />
                                </div>
                            </div>
                            <div class="row">
