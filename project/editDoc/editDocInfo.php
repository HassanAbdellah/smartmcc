...
if (isset($_SESSION['loginEmail'])) {
    ...
    if (isset($_REQUEST['saveChange'])) {
        $id = $_GET['id'];
        $newInfo = $_REQUEST['newInfo'];

        $d = mysqli_query($con, "SELECT * FROM doctors where id='$id'");
        $num = mysqli_num_rows($d);

        $result = mysqli_query($con, "UPDATE doctors SET info='$newInfo' WHERE id='$id'");
...
?>
            ...
            <form role="form" method="post" class="form-horizontal" enctype="multipart/form-data"><br>
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        <textarea class="form-control" id="newInfo" name="newInfo" placeholder="Enter Doctor's Informations here..."></textarea>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
